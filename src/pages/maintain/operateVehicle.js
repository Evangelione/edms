                ...
                <Col span={24}>
                  ...
                  >
                    {getFieldDecorator('logistic_company', {
                      ...
                      rules: [{required: true, message: '请填写物流公司名称！'}],
                    })(
                      <Input placeholder="请填写物流公司名称..."/>
                    )}
                  </FormItem>
                </Col>
                <Col span={24}>
                  ...
                  >
                    {getFieldDecorator('logistic_contact', {
                      ...
                      rules: [{required: true, message: '请填写物流公司联系人！'}],
                    })(
                      <Input placeholder="请填写物流公司联系人..."/>
                    )}
                  </FormItem>
                </Col>
                <Col span={24}>
